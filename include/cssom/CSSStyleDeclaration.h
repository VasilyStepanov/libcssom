...
const char * CSSOM_CSSStyleDeclaration_font(const CSSOM_CSSStyleDeclaration * cssStyleDeclaration);



void CSSOM_CSSStyleDeclaration_setFont(CSSOM_CSSStyleDeclaration * cssStyleDeclaration, const char * font);
