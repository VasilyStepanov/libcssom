#ifndef _CSSOM_LEXICAL_UNIT_RANGE_CURSOR_H
#define _CSSOM_LEXICAL_UNIT_RANGE_CURSOR_H
...
const SAC_LexicalUnit** CSSOM_LexicalUnitRange_cursor(const CSSOM *cssom,
