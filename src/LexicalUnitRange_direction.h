#ifndef _CSSOM_LEXICAL_UNIT_RANGE_DIRECTION_H
#define _CSSOM_LEXICAL_UNIT_RANGE_DIRECTION_H
...
const SAC_LexicalUnit** CSSOM_LexicalUnitRange_direction(const CSSOM *cssom,
