...
typedef enum _CSSOM_CSSPropertyType {
  ...
  CSSOM_SRC_PROPERTY = 104,
  CSSOM_STRESS_PROPERTY = 105,
  CSSOM_TABLE_LAYOUT_PROPERTY = 106,
  CSSOM_TEXT_ALIGN_PROPERTY = 107,
  CSSOM_TEXT_DECORATION_PROPERTY = 108,
  CSSOM_TEXT_INDENT_PROPERTY = 109,
  CSSOM_TEXT_SHADOW_PROPERTY = 110,
  CSSOM_TEXT_TRANSFORM_PROPERTY = 111,
  CSSOM_TOP_PROPERTY = 112,
  CSSOM_UNICODE_BIDI_PROPERTY = 113,
  CSSOM_VERTICAL_ALIGN_PROPERTY = 114,
  CSSOM_VISIBILITY_PROPERTY = 115,
  CSSOM_VOICE_FAMILY_PROPERTY = 116,
  CSSOM_VOLUME_PROPERTY = 117,
  CSSOM_WHITE_SPACE_PROPERTY = 118,
  CSSOM_WIDOWS_PROPERTY = 119,
  CSSOM_WIDTH_PROPERTY = 120,
